seqfile = codon.nuc            * Path to the alignment file
     treefile = tree.trees           * Path to the tree file
      outfile = null_blank.txt            * Path to the output file
    ...
    cleandata = 0              * Remove sites with ambiguity data?
        model = 2         * Models for  ^i varying across lineages
  NSsites = 2          * Models for  ^i varying across sites
